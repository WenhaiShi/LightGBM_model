...
def load_model():
    try:
        # 尝试直接加载模型
        model = joblib.load('final_LightGBM_model_selected_features.pkl')
...
if selected_features is None:
    selected_features = ['Age', 'LOS', 'Weight', 'SOFA', 'PH', 'PCO2', 'OI', 'WBC', 'MCHC', 'Calcium', 'INR', 'Chloride', 'Glucose', 'PT', 'ALT', 'Average output urine']
...
- **Vital Signs & Blood Gas**: {', '.join([f for f in selected_features if f in ['PH', 'PCO2', 'OI']])}
